<template>
    <div id="contact_us_container"> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <div style="margin-bottom:-40px">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2879.8909756114263!2d-79.42448398449761!3d43.7958752791166!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b2cfe2fd16f43%3A0xc5d9645af2ab219!2sCenterpoint+Mall!5e0!3m2!1sen!2sca!4v1545406728624" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
    </div>
</template>
            ...
            methods: {
                ...
                loadData: async function() {
                    try {
                        ...
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "	/pages/centerpoint-contact-us.json"}),this.$store.dispatch("getData", "repos")]);
                        return results;
                    } catch (e) {
