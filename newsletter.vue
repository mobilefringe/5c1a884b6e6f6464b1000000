                    		...
                    		<div>
                    			<div class="form-group row">
                                    <div class="col-sm-6 col-xs-12">
                                        ...
                                        <input aria-label="Name" id="fieldName" maxlength="200" name="cm-name" reguired>
                                    </div>
                               
                                    <div class="col-sm-6 col-xs-12">
                                        <label>Email </label>
                                        <input autocomplete="Email" aria-label="Email" class="js-cm-email-input qa-input-email" id="fieldEmail" maxlength="200" name="cm-gmkjr-gmkjr" required="" type="email">
                                    </div>
                    			</div>
                        ...
                        <div class="form-group ">
                            <div class="col-sm-6 col-xs-12" >
                             ...
                             <div class="col-sm-6 col-xs-12">
                                ...
                                <input v-model="form_data.email" required class="form-control js-cm-email-input" name="cm-gmkjr-gmkjr" type="email" placeholder="Email" id="newsletter_email">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
